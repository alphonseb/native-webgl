...
var loop = function loop() {
  ...
  time += 0.1; // time % 1 === 0 ? h1.textContent = time : null

  gl.drawArrays(gl.TRIANGLES, 0, vertices.length / 2); // gl.clear(gl.COLOR_BUFFER_BIT)
}; // loop()
...
//# sourceMappingURL=/shaders.e31bb0bc.js.map